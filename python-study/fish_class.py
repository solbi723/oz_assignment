class Shop:
    ...
    def manage_stock(self):
        while True:
            ...
            self.stock[bread_type] += bread_count  # stock["초코붕어빵"] 5 + bred_count 10 => 15 => stock["초코붕어빵"] = 15
            print(f'{bread_type}의 재고가 {bread_count}개 추가되었습니다.')

    def total_sales(self):
        total_sales = sum(self.sales[bread] * self.price[bread] for bread in sales)
